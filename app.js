...
const THEME_ORDER = ["dark", "dim", "mint", "light"];
const THEME_META = {
  dark: { icon: "🌙", themeColor: "#0f1115", nextLabel: "Mittleres Theme aktivieren" },
  dim: { icon: "🌗", themeColor: "#3b4252", nextLabel: "Mint-Modus aktivieren" },
  mint: { icon: "🌱", themeColor: "#a8ddc2", nextLabel: "Hellen Modus aktivieren" },
